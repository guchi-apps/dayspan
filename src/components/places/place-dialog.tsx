  ...
  return (
    <>
      {/*
        ...
        地点を持たない場所（座標の欄が空・外したあと）では、名前ではなく**住所**から引く
        （`lookupText`。issue #464）。名前欄に入っているのは「自宅」「本社」のような値で、
        そこからは地点が引けず、登録されている住所を使わないまま前回の中心や東京駅から
        始まっていた。住所も空なら従来どおり名前で引く。
      */}
      {mapOpen && (
        <PlaceMapDialog
          query={name}
