 ...
 * 広い画面では実物と同じく、出張・年休を左、月の内容を右に置く（issue #636）。
 */
  ...
  return (
    <AppFrameSkeleton>
      ...
      <div className="min-h-0 flex-1 overflow-hidden">
        <div className="mx-auto flex w-full max-w-2xl flex-col gap-6 p-6 @4xl/main:grid @4xl/main:max-w-6xl @4xl/main:grid-cols-[minmax(0,2fr)_minmax(0,3fr)] @4xl/main:items-start @4xl/main:gap-x-8">
          {/* 出張・年休の区画。狭い画面では月切替より上に来る（issue #510）。 */}
